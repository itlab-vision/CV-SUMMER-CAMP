...
DnnDetector::DnnDetector(String path_to_model, String path_to_config, String path_to_labels, int inputWidth, int inputHeight, Scalar mean, bool swapRB)
{
...
vector<DetectedObject> DnnDetector::Detect(Mat image)
{
	...
	Mat matrix = result.reshape(1, 100);
