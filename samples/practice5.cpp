...
int main(int argc, char** argv) {
	...
	video_name = "C:/Users/temp2019/Desktop/lindigas/data/topdogs.mp4";
	detector_model = "C:/Users/temp2019/Desktop/lindigas/data/mobilenet-ssd.prototxt";
	detector_weights = "C:/Users/temp2019/Desktop/lindigas/data/mobilenet-ssd.caffemodel";
	string model_path = "C:/Users/temp2019/Desktop/lindigas/data/squeezenet1.1.caffemodel";
	string config_path = "C:/Users/temp2019/Desktop/lindigas/data/squeezenet1.1.prototxt";
	string labels_path = "C:/Users/temp2019/Desktop/lindigas/data/squeezenet1.1.labels";
	...
	for (;; )
	{
		...
		for (const auto &detection : tracker->trackedDetections()) {
			...
			Classificator* c1 = new DnnClassificator(model_path, config_path, labels_path, 300, 300, Scalar(104.0, 117.0, 123.0), false, 1.0);
			Mat prob = c1->Classify(image);
			...
			std::string text = std::to_string(detection.object_id) + (labels[classId - 1]) + "conf:" + std::to_string(detection.confidence);

			cv::putText(frame, text, detection.rect.tl(), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(100, 1000, 101), 1);
